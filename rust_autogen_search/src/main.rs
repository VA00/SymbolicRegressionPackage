...
fn main() {
    ...
    println!(
        "Run config: gen_k={} gen_k_const={} verify_k={} max_keep_per_level={} require_full_deps={} quotient_var_permutations={}",
        gen_k, gen_k_const, verify_k, max_keep_per_level, require_full_deps, quotient_var_permutations
    );
